...
export default function FavoriteScreen() {
    ...
    const [favorites, setFavorites] = useState<Product[]>(favoriteStore.getFavorites());
            ...
            <View className="flex-1 ml-3">
                <View className="flex-row justify-between items-start">
                    ...
                    <View className="flex-row items-center">
                        ...
                        <Text className="text-xs font-bold text-gray-600 ml-1">4.7 (2.5k)</Text>
                    </View>
                </View>

                <Text className="text-lg font-bold text-gray-900 mb-1">$ {item.price}</Text>

                <Text className="text-xs text-gray-500 mb-2">America • Burger • Fries</Text>

                <View className="flex-row items-center justify-between">
                    <View className="flex-row items-center gap-3">
                        <View className="flex-row items-center">
                            <Ionicons name="time-outline" size={14} color="#9CA3AF" />
                            <Text className="text-xs text-gray-500 ml-1">15-30 min</Text>
                        </View>
                        <View className="flex-row items-center">
                            <Ionicons name="bicycle-outline" size={14} color="#9CA3AF" />
                            <Text className="text-xs text-gray-500 ml-1">8.0km</Text>
                        </View>
                    </View>
