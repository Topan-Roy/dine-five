    ...
    return (
        <SafeAreaView className="flex-1 bg-[#FDFBF7]">
            ...
            <ScrollView className="flex-1 px-6">
                {/* Default */}
                <Text className="text-gray-500 text-xs mb-3 ml-1">Default</Text>
                <TouchableOpacity className="bg-white p-4 rounded-2xl mb-6 flex-row justify-between items-center border border-gray-100 shadow-sm">
                    <Text className="text-base font-semibold text-gray-900">Mastercard - Daniel Jones</Text>
                    <Ionicons name="chevron-forward" size={20} color="#9CA3AF" />
                </TouchableOpacity>

                {/* Others */}
                <Text className="text-gray-500 text-xs mb-3 ml-1">Others</Text>
                <TouchableOpacity className="bg-white p-4 rounded-2xl mb-4 flex-row justify-between items-center border border-gray-100 shadow-sm">
                    <Text className="text-base font-semibold text-gray-900">Mastercard - Emily Jones</Text>
                    <Ionicons name="chevron-forward" size={20} color="#9CA3AF" />
                </TouchableOpacity>
            </ScrollView>
        </SafeAreaView>
