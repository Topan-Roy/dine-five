...
const HOTEL_PRODUCTS = [
    { id: 1, hotelId: 1, name: 'Margherita Pizza', price: '8.99', image: 'https://images.unsplash.com/photo-1574071318508-1cdbab80d002?w=500', isNew: false },
    { id: 2, hotelId: 1, name: 'Pepperoni Feast', price: '10.99', image: 'https://images.unsplash.com/photo-1628840042765-356cda07504e?w=500', isNew: true },
    { id: 3, hotelId: 1, name: 'Cheese Burst', price: '12.99', image: 'https://images.unsplash.com/photo-1513104890138-7c749659a591?w=500', isNew: true },
    { id: 4, hotelId: 2, name: 'Chicken Curry', price: '14.99', image: 'https://images.unsplash.com/photo-1565557623262-b51c2513a641?w=500', isNew: false },
    { id: 5, hotelId: 2, name: 'Naan Bread', price: '2.99', image: 'https://images.unsplash.com/photo-1606471191009-63994c53433b?w=500', isNew: false },
    { id: 6, hotelId: 1, name: 'Veggie Supreme', price: '9.99', image: 'https://images.unsplash.com/photo-1571091718767-18b5b1457add?w=500', isNew: false },
];
...
export default function HotelDetailsScreen() {
    ...
    return (
        <View className="flex-1 bg-[#FDFBF7]">
            ...
            <ScrollView className="flex-1 z-10 mx-4" showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 100 }}>
                {/* Transparent Spacer */}
                ...
                <View className="bg-white rounded-t-3xl p-5 shadow-sm min-h-screen">
                    ...
                    <View className="flex-row items-center justify-between mb-4">
                        ...
                        <View className="bg-yellow-100 px-3 py-1 rounded-full">
                            <Text className="text-xs font-semibold text-yellow-700">{products.length} Items</Text>
                        </View>
                    </View>
